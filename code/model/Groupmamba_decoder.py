    ...
    def __initv2__(
        ...
        **kwargs,    
        ...
        if selective_scan_cuda_core is not None:
            scan_backend = SelectiveScanCore
            scan_backend_name = "selective_scan_cuda_core"

        elif selective_scan_cuda is not None:
            scan_backend = SelectiveScanMamba
            scan_backend_name = "selective_scan_cuda"

        elif selective_scan_cuda_oflex is not None:
            scan_backend = SelectiveScanOflex
            scan_backend_name = "selective_scan_cuda_oflex"

        else:
            raise RuntimeError(
                "No selective-scan CUDA backend is available. "
                "Need one of: selective_scan_cuda_core, "
        ...
        FORWARD_TYPES = dict(
            ...
            v2=partial(self.forward_corev2, force_fp32=(not self.disable_force32), SelectiveScan=scan_backend),
        )
